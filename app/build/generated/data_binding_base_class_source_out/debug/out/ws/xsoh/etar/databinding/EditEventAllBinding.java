...
public final class EditEventAllBinding implements ViewBinding {
  ...
  @NonNull
  public final MaterialButton btnModeAllday;

  @NonNull
  public final MaterialButton btnModePeriod;

  @NonNull
  public final MaterialButton btnModePoint;

  @NonNull
  public final Button btnSmartInput;

  @NonNull
  public final MaterialButton btnSpecialAnniversary;

  @NonNull
  public final MaterialButton btnSpecialBirthday;

  @NonNull
  public final MaterialButton btnSpecialCountdown;

  @NonNull
  public final MaterialButton btnSpecialNone;
  ...
  @NonNull
  public final MaterialButtonToggleGroup specialDayGroup;
  ...
  private EditEventAllBinding(@NonNull LinearLayout rootView, @NonNull Group addAttendeesGroup,
      ...
      @NonNull ImageView availabilityIcon, @NonNull MaterialButton btnModeAllday,
      @NonNull MaterialButton btnModePeriod, @NonNull MaterialButton btnModePoint,
      @NonNull Button btnSmartInput, @NonNull MaterialButton btnSpecialAnniversary,
      @NonNull MaterialButton btnSpecialBirthday, @NonNull MaterialButton btnSpecialCountdown,
      @NonNull MaterialButton btnSpecialNone, @NonNull View calendarSelectorGroupBackground,
      ...
      @NonNull MaterialSwitch isAllDay, @NonNull AutoCompleteTextView location,
      ...
      @NonNull Button timezoneButton, @NonNull Group timezoneButtonRow,
      @NonNull ImageView timezoneIcon, @NonNull TextView timezoneTextView,
      @NonNull LinearLayout timezoneTextviewRow, @NonNull TextInputEditText title,
      @NonNull LinearLayout toRowHomeTz, @NonNull EditText url, @NonNull ImageView urlIcon,
    ...
    this.btnModeAllday = btnModeAllday;
    this.btnModePeriod = btnModePeriod;
    this.btnModePoint = btnModePoint;
    this.btnSmartInput = btnSmartInput;
    this.btnSpecialAnniversary = btnSpecialAnniversary;
    this.btnSpecialBirthday = btnSpecialBirthday;
    this.btnSpecialCountdown = btnSpecialCountdown;
    this.btnSpecialNone = btnSpecialNone;
  ...
  public static EditEventAllBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      MaterialButton btnModeAllday = ViewBindings.findChildViewById(rootView, id);
      if (btnModeAllday == null) {
        break missingId;
      }

      id = R.id.btn_mode_period;
      MaterialButton btnModePeriod = ViewBindings.findChildViewById(rootView, id);
      if (btnModePeriod == null) {
        break missingId;
      }

      id = R.id.btn_mode_point;
      MaterialButton btnModePoint = ViewBindings.findChildViewById(rootView, id);
      if (btnModePoint == null) {
        break missingId;
      }
      ...
      id = R.id.btn_special_anniversary;
      MaterialButton btnSpecialAnniversary = ViewBindings.findChildViewById(rootView, id);
      if (btnSpecialAnniversary == null) {
        break missingId;
      }

      id = R.id.btn_special_birthday;
      MaterialButton btnSpecialBirthday = ViewBindings.findChildViewById(rootView, id);
      if (btnSpecialBirthday == null) {
        break missingId;
      }

      id = R.id.btn_special_countdown;
      MaterialButton btnSpecialCountdown = ViewBindings.findChildViewById(rootView, id);
      if (btnSpecialCountdown == null) {
        break missingId;
      }

      id = R.id.btn_special_none;
      MaterialButton btnSpecialNone = ViewBindings.findChildViewById(rootView, id);
      if (btnSpecialNone == null) {
        break missingId;
      }
      ...
      id = R.id.special_day_group;
      MaterialButtonToggleGroup specialDayGroup = ViewBindings.findChildViewById(rootView, id);
      ...
      return new EditEventAllBinding((LinearLayout) rootView, addAttendeesGroup, addAttendeesRow,
          attendees, attendeesIcon, availability, availabilityIcon, btnModeAllday, btnModePeriod,
          btnModePoint, btnSmartInput, btnSpecialAnniversary, btnSpecialBirthday,
          btnSpecialCountdown, btnSpecialNone, calendarSelectorGroupBackground,
          ...
          title, toRowHomeTz, url, urlIcon, urlRow, view, view1, view2, view3, view4, view5, view6,
          view7, visibility, visibilityIcon, when, whenLabel, whenRow, whereIcon, whereRow);
    }
